classdef WindingData < handle
    ...
    %        - The material data is generated by 'source_scratch/material/run_winding.m'
    %
    ...
    properties (SetAccess = private, GetAccess = public)
        ...
        param % struct: struct of vectors containg the constant properties for each sample
        interp % cell: cell containg the interpolation object for the different materials
    ...
    methods (Access = public)
        ...
        function cost = get_cost(self)
            ...
            %
            %    Returns:
            %        cost (vector): cost of the different samples
    ...
    methods (Access = private)
        ...
        function parse_data(self, id_vec, id, param_tmp)
            ...
            %        id (vector): material id of each sample
            %        param_tmp (cell): constant properties of the provided materials
