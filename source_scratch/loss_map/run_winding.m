...
%% sigma
material.interp.T = [20 46 72 98 124 150];
material.interp.sigma = 1e7.*[5.800 5.262 4.816 4.439 4.117 3.839];

%% param
material.param.fill = fill;
material.param.d_strand = d_strand;
material.param.d_skin_min = d_skin_min;
...
material.param.fact_freq_max = 50.0;
